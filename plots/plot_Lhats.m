function [mean_hat std_hat] = plot_Lhats(Lhats,alg)
...
for i=1:length(fields)
    mean_hat.(fields{i})=mean(temp.(fields{i}),2);
    std_hat.(fields{i})=std(temp.(fields{i}),[],2);
    errorbar(alg.num_train_samples,mean_hat.(fields{i}),std_hat.(fields{i}),...
...
legend(gca,fields,'Location','SouthWest')
