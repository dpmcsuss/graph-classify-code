...
% xval.s0_trn = constants.s0;   % list of #'s of hold-out samples for class 0
% xval.s1_trn = constants.s1;   % list of #'s of hold-out samples for class 1
xval.num_iters = constants.s;
...
num_edges=unique(round(logspace(2,log10(max_edges),10)));
...
set(gca,'Xscale','log')
axis([num_edges(1) num_edges(end) 0 0.7])
