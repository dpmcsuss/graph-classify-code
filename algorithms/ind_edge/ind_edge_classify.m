function [Lhat Lvar yhat] = ind_edge_classify(preds,targs,params,subspace)
% this script does naive bayes classification, using a (sub-)space
% specified by user
%
% INPUT:
%   preds:    an array (currently typically n x n x s) of predictor variables
%   targs:    a list of targs (typically 1 x s)
