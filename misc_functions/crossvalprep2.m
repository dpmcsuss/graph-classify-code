function [Atrn Gtrn Atst Gtst inds] = crossvalprep2(As,constants,xval,i)
...
if ~isfield(xval,'num_iters'),
    xval.num_iters=max_iters;
end

% if num_iters is greater than all possible permutations, then simply do all possible permutations
if xval.num_iters>=max_iters && nargin==4
